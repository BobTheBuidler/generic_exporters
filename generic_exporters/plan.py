...
@final
class TimeDataRow(_TimeDataBase, _AwaitableMixin[Dict["Metric", Decimal]]):
    ...
    def _coros(self) -> List[Coroutine[Decimal, None, None]]:
        try:
            return [metric.produce(self.timestamp, sync=False) for metric in self.metrics]
        except AttributeError as e:
            raise AttributeError(str(e), self.metrics)
    #@cached_property
